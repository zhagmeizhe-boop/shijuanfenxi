...
class Settings(BaseSettings):
    ...
    VISION_LLM_CONCURRENCY: int = 4
    VISION_LLM_PAGE_TIMEOUT: float = 150.0
    VISION_LLM_MAX_ATTEMPTS: int = 3
    VISION_LLM_RETRY_BASE_SECONDS: float = 1.5
    ...
    QUESTION_LLM_TIMEOUT_SECONDS: float = 180.0
    QUESTION_LLM_REQUEST_TIMEOUT_SECONDS: float = 90.0
    QUESTION_LLM_MAX_ATTEMPTS: int = 2
    QUESTION_LLM_RETRY_BASE_SECONDS: float = 1.0
    DIM5_GROUNDED_LLM_ENABLED: bool = False
    GLOBAL_LLM_CONCURRENCY: int = 14
    GLOBAL_VISION_LLM_CONCURRENCY: int = 4
    GLOBAL_QUESTION_LLM_CONCURRENCY: int = 10
