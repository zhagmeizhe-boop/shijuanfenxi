...
async def health_check():
    ...
    return {
        ...
        "vision_llm_page_timeout": settings.VISION_LLM_PAGE_TIMEOUT,
        "vision_llm_max_attempts": settings.VISION_LLM_MAX_ATTEMPTS,
        "question_llm_concurrency": settings.QUESTION_LLM_CONCURRENCY,
        "question_llm_timeout_seconds": settings.QUESTION_LLM_TIMEOUT_SECONDS,
        "question_llm_request_timeout_seconds": settings.QUESTION_LLM_REQUEST_TIMEOUT_SECONDS,
        "question_llm_max_attempts": settings.QUESTION_LLM_MAX_ATTEMPTS,
